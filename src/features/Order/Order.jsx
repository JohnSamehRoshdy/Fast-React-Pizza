...
function Order() {
    ...
    return (
        <div className="space-y-8 px-4 py-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 bg-stone-200 bg-opacity-50 px-6 py-5 ">
            ...
            <ul className="divide-y divide-stone-400 border-b">
                {cart.map((item) => (
                    <OrderItem
                        item={item}
                        key={item.pizzaId}
            ...
            <div className="space-y-2 bg-stone-200 bg-opacity-50 px-6 py-5">
